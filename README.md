...
The `dev-toolbox` project contains the most useful binaries in one image. It is an Alpine-based image that can be used, for example, as a script executor inside a cluster or base image for [devcontainers](https://code.visualstudio.com/docs/devcontainers/containers).
